...
async def seed_content():
    if await db.leaders.count_documents({}) == 0:
        await db.leaders.insert_many([
            {"id": str(uuid.uuid4()), "name_hi": "श्री राजेश प्रताप सिंह", "name_en": "Rajesh Pratap Singh", "designation_hi": "राष्ट्रीय अध्यक्ष", "designation_en": "National President", "profile_hi": "25 वर्षों से जनसेवा में सक्रिय। संगठन विस्तार और युवा सशक्तिकरण के प्रति समर्पित।", "profile_en": "Serving the people for 25 years. Dedicated to organisational growth and youth empowerment.", "photo": "https://images.unsplash.com/photo-1584554376766-ac0f2c65e949?crop=entropy&cs=srgb&fm=jpg&q=85&w=600", "special": True, "active": True},
            {"id": str(uuid.uuid4()), "name_hi": "श्रीमती अनिता देशमुख", "name_en": "Anita Deshmukh", "designation_hi": "राष्ट्रीय महासचिव", "designation_en": "National General Secretary", "profile_hi": "महिला सशक्तिकरण और शिक्षा सुधार की प्रेरक वक्ता।", "profile_en": "Inspiring voice for women empowerment and education reform.", "photo": "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?crop=entropy&cs=srgb&fm=jpg&q=85&w=600", "special": True, "active": True},
